...
export function InitButton({
    ...
    const buttonType = {
        primary: 'bg-blue-600 text-white font hover:bg-blue-800 dark:bg-blue-900 dark:hover:bg-blue-950',
        secondary: 'bg-gray-200 text-black dark:text-white hover:bg-gray-300 dark:bg-gray-700  dark:hover:bg-gray-600',
